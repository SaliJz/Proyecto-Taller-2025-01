...
//    [Header("Referencias")]
//    public Transform columna;                    // Transform de la columna
//    public KeyCode teclaActivacion = KeyCode.P;  // Tecla para iniciar movimiento y enrollado

//    private SnakeController snake;               // Referencia al controlador de la serpiente
//    private Transform cabeza;                    // La cabeza de la serpiente
//    private bool activado = false;               // Si se activó el movimiento hacia la columna
//    private bool isWrapping = false;             // Si está en proceso de enrollado
...
//    IEnumerator Start()
//    {
//        yield return null; // Espera un frame para que SnakeController inicialice segmentos

//        snake = GetComponent<SnakeController>();
//        if (snake == null || snake.Segmentos.Count == 0)
//        {
//            Debug.LogError("SnakeController no inicializado o sin segmentos.");
//            yield break;
//        }
//        cabeza = snake.Segmentos[0];
//        if (columna == null) Debug.LogError("Columna no asignada.");

//        // Asegura que el snake esté activo al empezar
//        snake.enabled = true;
//    }

//    void Update()
//    {
//        if (snake == null || cabeza == null || columna == null) return;

//        // Al presionar la tecla, dirigimos la cabeza hacia la columna
//        if (!activado && Input.GetKeyDown(teclaActivacion))
//        {
//            snake.jugador = columna;
//            activado = true;
//        }

//        // Una vez activado, si llega al umbral, iniciamos enrollado
//        if (activado && !isWrapping)
//        {
//            float dist = Vector3.Distance(
//                new Vector3(cabeza.position.x, 0, cabeza.position.z),
//                new Vector3(columna.position.x, 0, columna.position.z)
...
//        // Calcula las posiciones de objetivo para cada segmento
//        List<Vector3> targetPos = new List<Vector3>(segCount);
//        float radio = GetColumnRadius();
//        float alturaTotal = snake.distanciaCabezaCuerpo
//                          + snake.separacionSegmentos * (segCount - 2)
...
//        // Animación de lerp entre startPos y targetPos
//        float elapsed = 0f;
//        while (elapsed < velocidadEnrollado)
//        {
//            float frac = elapsed / velocidadEnrollado;
...
//        // Mantener la serpiente en la posición enrollada y evitar que baje
//        // (no volvemos a activar snake.enabled aquí)
//        isWrapping = false;

//        // Desactiva este controlador para que no se repita el proceso
//        this.enabled = false;
//    }
