...
//    [Header("Scripts a activar al morir")]
//    [Tooltip("Arrastra aquí los componentes que quieras habilitar cuando la fase 2 termine.")]
//    public MonoBehaviour[] scriptsToActivate;

//    [Header("Scripts a eliminar al morir")]
//    [Tooltip("Arrastra aquí los componentes que quieras destruir cuando la fase 2 termine.")]
//    public MonoBehaviour[] scriptsToRemove;
...
//            // 1. Desactivar el ColumnWrapOnInput para que deje de mantener la serpiente alrededor de la columna
//            if (columnWrapper != null)
//            {
//                columnWrapper.enabled = false;
//                columnWrapper.StopAllCoroutines();
...
//            // 2. Desactivar SnakeColumnWrapOnInput (por si aún quedaba alguna rutina interna)
//            if (snakeAttack != null)
//            {
//                snakeAttack.enabled = false;
//                snakeAttack.StopAllCoroutines();
...
//            // 3. Finalmente, habilitar el SnakeController para que la serpiente pase a moverse libremente
//            SnakeController snakeCtrl = GetComponent<SnakeController>();
//            if (snakeCtrl != null)
//            {
//                // Apuntar al objeto "Player" en lugar de a la columna
...
//            // 4. Activar los scripts que estén en el array 'scriptsToActivate'
...
//            // 5. Eliminar los scripts que estén en el array 'scriptsToRemove'
