...
//    public float spawnRadius = 2f;          // Radio de dispersi�n alrededor del punto

//    [Header("Progresi�n de dificultad")]
//    public float levelDuration = 60f;       // Tiempo (segundos) para aumentar nivel
//    private float levelTimer = 0f;
//    private int currentLevel = 1;           // Nivel 1 => 2 enemigos �nicos
//    private int maxLevel = 3;               // Nivel 3 => 4 enemigos �nicos
...
//        {
//            Debug.Log("L�mite de enemigos en escena alcanzado.");
//            return true;
//        }
//        if (maxEnemiesInTotal >= 0 && totalEnemiesSpawned >= maxEnemiesInTotal)
//        {
//            Debug.Log("L�mite global de enemigos alcanzado.");
//            return true;
//        }
//        return false;
//    }

//    // Nuevo m�todo: elige N �ndices �nicos basados en currentLevel
//    private void SpawnWaveUnique()
//    {
//        int uniqueCount = Mathf.Clamp(currentLevel + 1, 2, 4);
//        // Preparar �ndices �nicos de prefab
...
//    {
//        // Mantener vieja funcionalidad si se llama expl�citamente
...
//    [SerializeField] private int maxEnemiesInScene = 20; // M�ximo de enemigos en la escena
//    [SerializeField] private int maxEnemiesInTotal = 50; // M�ximo de enemigos totales 
...
//        if (totalEnemiesSpawned < 0) totalEnemiesSpawned = 0; // Evitar n�meros negativos
//    }
...
//        if (activeEnemies.Count >= maxEnemiesInScene)
//        {
//            Debug.Log("L�mite de enemigos alcanzado. Esperando espacio libre...");
...
//        {
//            Debug.Log("No hay espacio para m�s enemigos.");
//            return; // No hay espacio para m�s enemigos
//        }
