...
public class PickupItem : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (rb != null)
        {
            switch (pickupType)
            {
                case PickupType.CodeFragment:
                    Debug.Log("Rigidbody encontrado, configurando propiedades para fragmento de c�digo");
                    rb.mass = 0.1f; // M�s "ligero"
                    rb.linearDamping = 1f;
                ...
                case PickupType.AmmoAuto:
                    Debug.Log("Rigidbody encontrado, configurando propiedades para munici�n");
                    rb.mass = 0.3f;
                    rb.linearDamping = 1f;
                    rb.angularDamping = 1f;
        ...
        // Si el objeto es un fragmento de c�digo, lo volamos hacia el jugador
