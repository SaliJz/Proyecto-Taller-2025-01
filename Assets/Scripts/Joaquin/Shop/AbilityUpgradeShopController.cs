...
public class AbilityUpgradeShopController : MonoBehaviour
{
    ...
    public void FinalizePurchase()
    {
        ...
        foreach (var upgrade in selectedUpgrades)
        {
            switch (upgrade.Key)
            {
                case "Cooldown": AbilityUpgradeManager.CooldownLevel++; break;
                case "Duration": AbilityUpgradeManager.EffectDurationLevel++; break;
                case "Range": AbilityUpgradeManager.EffectRangeLevel++; break;
            }
        }

        AbilityUpgradeManager.NotifyUpgradesChanged();
    ...
    {
        if (abilityUpgradeMenu != null) abilityUpgradeMenu.SetActive(false);
